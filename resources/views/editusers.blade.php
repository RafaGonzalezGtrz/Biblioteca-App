                                ...
                                <div class="col-xl-12" >
                                    <form action="{{route('users.update', $user->id)}}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="nombre">ID del usuario</label><br>
                                            <input type="text" class="form-control border border-black" name="id" required value="{{$user->id}}">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="descripcion">Nombre del usuario</label><br>
                                            <textarea type="textarea" class="form-control border border-black " name="name" required maxlength="100">{{$user->name}}</textarea>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="autor">email</label><br>
                                            <input type="text" class="w- border border-black" name="email" required value="{{$user->email}}">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="categoria">Contraseña</label><br>
                                            <input type="password" class="form-control border border-black" name="password" required value="{{$user->password}}">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="categoria">Roll</label><br>
                                            <input type="text" class="form-control border border-black" name="role" required value="{{$user->role}}">
                                        </div>
                                        <br>
                                        <div class="form-group">
