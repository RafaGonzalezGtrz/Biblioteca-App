            ...
            <div class="w-full flex flex-col h-screen overflow-y-hidden">
                ...
                <div class="w-full overflow-x-hidden border-t flex flex-col">
                    <main class="w-full flex-grow p-6">
                        <!--Formulario -->
                        <div class="container">
                            <h1 class="text-4xl">Subir nuevo libro</h1><br>
                            <div class="row ">
                                <div class="col-xl-12" >
                                    <form action="{{route('search.store')}}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border border-black" name="nombre" required>
                                        </div><br>
                                        <div class="form-group">
                                            <label for="descripcion">Descripción</label><br>
                                            <textarea type="text" class="form-control border border-black" name="descripcion" required maxlength="100"></textarea>
                                        </div><br>
                                        <div class="form-group">
                                            <label for="autor">Autor</label><br>
                                            <input type="text" class="w- border border-black" name="autor" required>
                                        </div><br>
                                        <div class="form-group">
                                            <label for="categoria">Categoria</label><br>
                                            <input type="text" class="form-control border border-black" name="categoria" required>
                                        </div><br>
                                        <div class="form-group">
                                            <label for="editorial">Editorial</label><br>
                                            <input type="text" class="form-control border border-black" name="editorial" required>
                                        </div><br>
                                        <div class="form-group">
                                            <label for="ISBN">Código ISBN</label><br>
                                            <input type="text" class="form-control border border-black" name="ISBN" required>
                                        </div><br>
                                        <div class="form-group">
