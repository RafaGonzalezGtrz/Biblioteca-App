        ...
        @else
            <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
                <div class="p-6">
                    ...
                    <p class="text-white text-1x1 font-light">Beta</p>
                    <a href="download" class="w-full bg-white cta-btn font-semibold py-2 mt-5 rounded-br-lg rounded-bl-lg rounded-tr-lg shadow-lg hover:shadow-xl hover:bg-gray-300 flex items-center justify-center">
        ...
        <div class="w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <div class="w-full overflow-x-hidden border-t flex flex-col">
                <main class="w-full flex-grow p-6">
                    <h1 class="text-3xl text-black pb-6">Aquí proximamente tu perfil de usuario @auth{{Auth::user()->name}} @endauth</h1>
                    <img src="https://images.milenio.com/H5OxlsB0vVppGeMsWJLw_hqEY9Q=/345x237/uploads/media/2021/06/03/mclovin-sony-pictures-entertainment.jpg">
                </main>
