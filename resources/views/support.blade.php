...
@section('content')
    ...
    <body class="bg-gray-100 font-family-comfortaa flex">
        ...
        <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
            <div class="p-6">
                <a href="http://localhost/Biblioteca-App/public/home" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">Biblioteca<br>Digital</a>
            ...
            <nav class="text-white text-base font-semibold pt-3">
                <a href="{{route('search')}}" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
        ...
        <div class="w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <img src="https://s3.getstickerpack.com/storage/uploads/sticker-pack/perrito-triste-1/1586112784.png?2aa4539f20f3879d7d94a804d39f9595&d=200x200" class="w-80"> 
